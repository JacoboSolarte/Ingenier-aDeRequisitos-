...
# Ejemplo de uso
empleado1 = Empleado("Santiago", 30, 50000)
empleado2 = Empleado("Jacobo", 28, 45000)
empleado3 = Directivo("Samuel", 35, 70000, "Gerente", [empleado1])
...
print(f"Nombre: {empleado3.nombre}, Edad: {empleado3.edad}, Sueldo Bruto: {empleado3.sueldo_bruto}, Categoría: {empleado3.categoria}")
